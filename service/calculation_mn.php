...
class calculation{
    ...
    public function getStyleType($height,$weight){
        ...
        //身体タイプ
        $style_type=" ᠮᠡᠳᠡᠬᠦ ᠦᠭᠡᠢ";
        //イメージ
        $style_image="images/timg.gif";

        if(25<=$bmi && $bmi<30){
            $style_type=" ᠮᠠᠷᠢᠶ᠎ᠠ ᠶᠢᠨ ᠬᠡᠮᠵᠢᠶ᠎ᠡ ᠨᠢᠭᠡ";
            $style_image="images/ng1.png";
        }
        if(30<=$bmi && $bmi<35){
            $style_type="ᠮᠠᠷᠢᠶ᠎ᠠ ᠶᠢᠨ ᠬᠡᠮᠵᠢᠶ᠎ᠡ  ᠬᠤᠶᠠᠷ";
            $style_image="images/ng2.png";
        }
        if(35<=$bmi && $bmi<40){
            $style_type="ᠮᠠᠷᠢᠶ᠎ᠠ ᠶᠢᠨ ᠬᠡᠮᠵᠢᠶ᠎ᠡ  ᠭᠤᠷᠪᠠ";
            $style_image="images/ng3.png";
        }
        if(40<=$bmi){
            $style_type="ᠮᠠᠷᠢᠶ᠎ᠠ ᠶᠢᠨ ᠬᠡᠮᠵᠢᠶ᠎ᠡ  ᠳᠦᠷᠪᠠ";
            $style_image="images/ng4.png";
        }
        if(18.5<=$bmi && $bmi<25){
            $style_type=" ᠳᠤᠮᠳᠠ ᠶᠢᠨ ᠪᠡᠶ᠎ᠡ᠂᠂ᠶᠡᠬᠡ ᠰᠠᠢᠨ";
            $style_image="images/ok.png";
        }
        if($bmi<18.5){
            $style_type=" ᠬᠡᠲᠦᠷᠬᠡᠢ ᠰᠢᠭᠤᠷᠬᠠᠢ";
